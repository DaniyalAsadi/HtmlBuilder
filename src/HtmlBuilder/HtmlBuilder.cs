...
public class HtmlBuilder
{
    ...
    /// </summary>
    /// <typeparam name="TTag">The type of the HTML tag to create. Must inherit from <see cref="CompositeDoubleTag"/> and have a parameterless constructor.</typeparam>
    ...
    public static TTag Create<TTag>(Action<TTag>? creator = null)
        where TTag : CompositeDoubleTag, new()
    {
        if (creator is null)
        {
            return new TTag();
